            ...
            <div className="p-4 bg-slate-100 h-full" style={{ width: 400 }}>
                ...
                {selectedMember && (
                    <div className="mt-4 grid justify-center items-center">
                        <div className=''>
                            <img
                                src={selectedMember.image || "https://cdn.pixabay.com/photo/2017/06/09/23/22/avatar-2388584_640.png"}
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">{selectedMember.email ||"vdv"}</p>
                            <p className="text-sm text-gray-600">{selectedMember.phone || "ff"}</p>
                            <p className="text-sm text-gray-600">{selectedMember.role || "ll"}</p>
                            <p className="text-sm text-gray-600">{selectedMember.slug || "ll"}</p>
                        </div>
                    </div>
                )}
            </div>
